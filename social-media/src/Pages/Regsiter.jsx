...
import { auth, createUserWithEmailAndPassword } from '../components/firebase/firebase';
    ...
    <section className="py-10 bg-gray-50 sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Sign up to get started</p>
        </div>
              ...
              <form action="#" method="POST" onSubmit={handleSubmit}>
                <div className="space-y-5">
                  ...
                  <div className="text-center">
                    <p className="text-base text-gray-600">Already have an account? <Link to="/Login" title="" className="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Sign in here</Link></p>
                  </div>
                </div>
              </form>
            </div>
